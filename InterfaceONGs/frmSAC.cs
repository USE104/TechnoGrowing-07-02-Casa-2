...
namespace InterfaceONGs
{
    public partial class frmSAC : Form
    {
        ...
        {
            MySqlCommand comm = new MySqlCommand();
            comm.CommandText = "select * from tbONG where Nome = '" + txtnomeONG.Text + "';";
            comm.CommandType = CommandType.Text;
            comm.Connection = Conexao.obterConexao();
        ...
        {
            if (MessageBox.Show("Confirma o retorno para Página Principal ?", "Mensagem do Sistema", MessageBoxButtons.OKCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.OK)
            {
            ...
            {
                MessageBox.Show("O retorno para Página Principal foi cancelado", "Mensagem do Sistema", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
            }
